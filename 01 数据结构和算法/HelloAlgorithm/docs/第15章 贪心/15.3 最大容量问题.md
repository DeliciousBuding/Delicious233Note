...
![max_capacity_example.png](max_capacity_example.png)
...
![max_capacity_initial_state.png](max_capacity_initial_state.png)

如下图所示，**若此时将长板 $j$ 向短板 $i$ 靠近，则容量一定变小**。

这是因为在移动长板 $j$ 后，宽度 $j-i$ 肯定变小；而高度由短板决定，因此高度只可能不变（ $i$ 仍为短板）或变小（移动后的 $j$ 成为短板）。

![max_capacity_moving_long_board.png](max_capacity_moving_long_board.png)

反向思考，**我们只有向内收缩短板 $i$ ，才有可能使容量变大**。因为虽然宽度一定变小，**但高度可能会变大**（移动后的短板 $i$ 可能会变长）。例如在下图中，移动短板后面积变大。

![max_capacity_moving_short_board.png](max_capacity_moving_short_board.png)
...
=== "<1>"
    ![max_capacity_greedy_step1.png](max_capacity_greedy_step1.png)

=== "<2>"
    ![max_capacity_greedy_step2.png](max_capacity_greedy_step2.png)

=== "<3>"
    ![max_capacity_greedy_step3.png](max_capacity_greedy_step3.png)

=== "<4>"
    ![max_capacity_greedy_step4.png](max_capacity_greedy_step4.png)

=== "<5>"
    ![max_capacity_greedy_step5.png](max_capacity_greedy_step5.png)

=== "<6>"
    ![max_capacity_greedy_step6.png](max_capacity_greedy_step6.png)

=== "<7>"
    ![max_capacity_greedy_step7.png](max_capacity_greedy_step7.png)

=== "<8>"
    ![max_capacity_greedy_step8.png](max_capacity_greedy_step8.png)

=== "<9>"
    ![max_capacity_greedy_step9.png](max_capacity_greedy_step9.png)
...
![max_capacity_skipped_states.png](max_capacity_skipped_states.png)
