...
![build_tree_example.png](build_tree_example.png)
...
![build_tree_preorder_inorder_division.png](build_tree_preorder_inorder_division.png)
...
![build_tree_division_pointers.png](build_tree_division_pointers.png)
...
![built_tree_step1.png](built_tree_step1.png)
![built_tree_step2.png](built_tree_step2.png)
![built_tree_step3.png](built_tree_step3.png)
![built_tree_step4.png](built_tree_step4.png)
![built_tree_step5.png](built_tree_step5.png)
![built_tree_step6.png](built_tree_step6.png)
![built_tree_step7.png](built_tree_step7.png)
![built_tree_step8.png](built_tree_step8.png)
![built_tree_step9.png](built_tree_step9.png)

每个递归函数内的前序遍历 `preorder` 和中序遍历 `inorder` 的划分结果如下图所示。

![built_tree_overall.png](built_tree_overall.png)
